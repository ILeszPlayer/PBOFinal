...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query(value = "SELECT c.id, c.isi_komentar, c.tanggal, u.nama, u.id FROM comments c JOIN users u ON c.user_id = u.id WHERE c.complaint_id = :complaintId ORDER BY c.tanggal ASC", nativeQuery = true)
